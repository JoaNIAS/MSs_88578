...
Ready dataset is here: https://drive.google.com/file/d/134seawx58YHSI8hfFuEFLJO_6S9P7sTk/view?usp=sharing  
...
# Dataset Generation
Run: Blender_pallet_scene_generation.py
...
# Run: run_geometry_from_yolo_predictions.py
...
# Run: check_geometry_all_results.py
